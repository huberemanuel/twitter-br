...
def main():
    ...
    num_train_steps = len(tokenized_train_dataset) // train_batch_size * num_epochs
    ...
    for epoch in epochs:
        ...
        num_train_samples = len(tokenized_train_dataset)
        ...
        for step, batch_idx in enumerate(
            ...
            samples = [tokenized_train_dataset[int(idx)] for idx in batch_idx]
            ...
            if cur_step % training_args.eval_steps == 0 and cur_step > 0:
                # ======================== Evaluating ==============================
                num_eval_samples = len(tokenized_eval_dataset)
                ...
                for i, batch_idx in enumerate(
                    ...
                    samples = [tokenized_eval_dataset[int(idx)] for idx in batch_idx]
                    model_inputs = data_collator(samples, pad_to_multiple_of=16)
