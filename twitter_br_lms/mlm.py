"""
Script to train or evaluate a given language model supported by HuggingFace.

This is an adaption from huggingface/transformers//examples/pytorch/language-\
    modeling/run_mlm.py
"""
...
from twitter_br_lms.args import DataTrainingArguments, ModelArguments
...
def main():
    ...
    if model_args.config_name:
        ...
        raise Exception("{} model type not supported".format(model_args.model_type))
    ...
    data_collator = DataCollatorForLanguageModeling(
        ...
        pad_to_multiple_of=8 if pad_to_multiple_of_8 else None,  # pad_to_max_length
    )
